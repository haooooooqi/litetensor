...
Download the Eigen3 zip file from http://bitbucket.org/eigen/eigen/get/3.3.1.zip. I put it in inlcude directory, you may need to modify the Eigen directory in CMakeLists. txt.
